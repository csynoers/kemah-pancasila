...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 17, 2020 at 08:21 AM
...
CREATE TABLE IF NOT EXISTS `client_kategori` (
  `id_client_kategori` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `school_sub` (
  ...
  `status` enum('Y','N') DEFAULT NULL,
  `last_update` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP
) ENGINE=MyISAM AUTO_INCREMENT=28 DEFAULT CHARSET=latin1 CHECKSUM=1 DELAY_KEY_WRITE=1 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE IF NOT EXISTS `slide_title` (
...
('::1', '2019-12-16', 2, '1578641670'),
('::1', '2019-12-17', 2, '1578641670'),
('::1', '2019-12-18', 2, '1578641670'),
('127.0.0.1', '2019-12-18', 122, '1576659138'),
('::1', '2019-12-19', 2, '1578641670'),
('::1', '2019-12-20', 2, '1578641670'),
('::1', '2019-12-21', 2, '1578641670'),
('::1', '2019-12-23', 2, '1578641670'),
('::1', '2019-12-24', 2, '1578641670'),
('::1', '2019-12-28', 2, '1578641670'),
('::1', '2019-12-30', 2, '1578641670'),
('::1', '2019-12-31', 2, '1578641670'),
('::1', '2020-01-02', 2, '1578641670'),
('::1', '2020-01-03', 2, '1578641670'),
('::1', '2020-01-04', 2, '1578641670'),
('::1', '2020-01-06', 2, '1578641670'),
('::1', '2020-01-07', 2, '1578641670'),
('::1', '2020-01-08', 2, '1578641670'),
('::1', '2020-01-09', 2, '1578641670'),
('::1', '2020-01-10', 2, '1578641670'),
('::1', '2020-01-17', 1, '1579245549');
...
(2, 'admin-72-bill-gates.jpeg', 'admin', 'QrUgcNdRjaE74hfEIeThKa/RaqA9N/KpBI+X7VeiyfE=', 'Admin', 'support@kemahpancasila.com', '0811-2687-75', 'admin', 'N', 'r5bd3c06gt1dn0u49a2lpm0ua1');
