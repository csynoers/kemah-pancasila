...
$(document).ready(function(){
    ...
    */
    ...
    $('#destination-form, #special-interest-form').submit(function(){
         var options = $('#multi-hotel > option:selected');
         if(options.length == 0){
            // swal("Please Choose at last 1 Hotel First!"
            // );
            swal({
                 title: "oops!",
                 text: "Please Choose at last 1 Hotel First!",
                 type: "warning",
                 buttons : false,
                 timer: 4000
                 });
