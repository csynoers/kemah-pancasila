...
<?php
    $aksi="modul/mod_testimonies/testimonies_c.php?module=testimonies";
    if (!isset($_GET['act'])) {
        $_GET['act'] = '';
    }
    switch($_GET['act']){
...
?>
                ...
                <div class="card">
                    <div class="card-body card-padding">
                        <p class="c-black f-500 m-b-20">Testimonies
                            <a href="?module=testimonies&act=add" class="btn bgm-deeppurple btn-sm m-t-10 waves-effect pull-right"><i class="zmdi zmdi-plus zmdi-hc-fw"></i> Add New</a>
                        </p>
                        ...
                        <div class="table-responsive">
                            <table class='display' id='datatables'>
                                ...
                                <?php
                                    $no=1;
                                    $posts = $database->select($fields="*", $table="testimonies", $where_clause="ORDER BY id_testimonies DESC", $fetch="all");
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="?module=testimonies&act=edit&id=<?php echo $value['id_testimonies'];?>" class="btn bgm-teal waves-effect"><i class="zmdi zmdi-edit zmdi-hc-fw"></i> Edit</a>
...
?>
                   <div class="card">
                        ...
                        <p class="c-black f-500 m-b-20">Testimonies / Add New</p>
                            <hr class="line">
...
?>
                   ...
                   <div class="card">
                        ...
                        <p class="c-black f-500 m-b-20">Testimonies / Edit</p>
                            <hr class="line">
