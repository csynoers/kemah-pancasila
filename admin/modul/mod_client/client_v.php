...
?>
                ...
                <div class="card">
                    <div class="card-body card-padding">
                        ...
                        <p class="c-black f-500 m-b-20">Client
...
?>
                   <div class="card">
                        <div class="card-body card-padding">
                            <p class="c-black f-500 m-b-20">Client / Add New</p>
                            <hr class="line">
                            ...
                            <form id="client-form" method="post" enctype="multipart/form-data" action="<?php echo $aksi;?>&act=insert">
                                <div class="row">
                                                    ...
                                                    <div class="fg-line">
                                                        ...
                                                        <div class="select">
                                                            <select class="form-control" name="kategori" id="d_kategori" required="require">
                                                                ...
                                                                <?php
                                                                    $kat = $database -> select($fields='*', $table='client_kategori', $where_clause='ORDER BY id_client_kategori DESC', $fetch='all'); 
                                                                    foreach ($kat as $key => $k) {
                                                                        echo '
                                                                            <option value="'.$k['id_client_kategori'].'">'.$k['judul'].'</option>
                                                                        ';
                                                                    }
                                                                ?>
                                                            </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div class="fg-line">
                                                <label>Logo Client <span class="color-red">*</span></label>
                                                <br>
...
?>
                   ...
                   <div class="card">
                        ...
                        <div class="card-body card-padding">
                            <p class="c-black f-500 m-b-20">Client / Edit</p>
                            <hr class="line">
                                                        ...
                                                        <div class="select">
                                                            <select class="form-control" name="kategori" id="d_kategori" required="require">
                                                                <?php
                                                                    $kat = $database -> select($fields='*', $table='client_kategori', $where_clause='ORDER BY id_client_kategori DESC', $fetch='all'); 
                                                                    foreach ($kat as $key => $k) {
                                                                        if ($k['id_client_kategori']==$value['id_client_kategori']) {
                                                                            echo '<option value="'.$k['id_client_kategori'].'" selected>'.$k['judul'].'</option>';
                                                                        } else {
                                                                            echo '
                                                                                <option value="'.$k['id_client_kategori'].'">'.$k['judul'].'</option>
                                                                            ';
