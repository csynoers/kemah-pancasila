...
<?php
        ...
        ?>
            <div class="card">
                <div class="card-body card-padding">
                    ...
                    <p class="c-black f-500 m-b-20">Penyelenggara
                    ...
                    <div class="table-responsive">
                        <table class='display' id='datatables'>
                            ...
                            <?php
                                $no=1;
                                $posts = $database->select($fields="*", $table="client", $where_clause="ORDER BY id_client DESC", $fetch="all");
                                foreach ($posts as $key => $value) {
                                    $kat = $database->select($fields="judul", $table="client_kategori", $where_clause="WHERE id_client_kategori='$value[id_client_kategori]'");
                            ?>

                                <tr>
                                    <th><?php echo $no; ?></th>
                                    <td><img src="../joimg/client/<?php echo $value['image'];?>" alt="" width="50px"></td>
                                    ...
                                    <td>
                                        <a href="?module=client&act=edit&id=<?php echo $value['id_client'];?>&kateg=<?php echo $value['id_client_kategori'] ?>" class="btn bgm-teal waves-effect"><i class="zmdi zmdi-edit zmdi-hc-fw"></i> Edit</a>
    ...
    case "add":
        ?>
            <div class="card">
                <div class="card-body card-padding">
                    <p class="c-black f-500 m-b-20">Penyelenggara / Add New</p>
                    <hr class="line">

                    <form id="client-form" method="post" enctype="multipart/form-data" action="<?php echo $aksi;?>&act=insert">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="fg-line">
                                        <label>Nama </label>
                                        <input type="text" name="judul" class="form-control" placeholder="Masukan nama penyelenggara disini*" maxlength="150" required="require">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="fg-line">
                                        <label>Logo Penyelenggara <span class="color-red">*</span></label>
                                        <br>
...
?>
                   ...
                   <div class="card">
                        ...
                        <div class="card-body card-padding">
                            <p class="c-black f-500 m-b-20">Penyelenggara / Edit</p>
                            <hr class="line">

                            <form id="client-form" method="post" enctype="multipart/form-data" action="<?php echo $aksi;?>&act=update">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div class="fg-line">
                                                <label>Nama</label>
                                                <input type="text" name="judul" class="form-control" placeholder="Masukan nama penyelenggara disini*"  value="<?php echo $value['nama'];?>" maxlength="128">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <div class="fg-line">
                                                <label>Keterangan</label>
                                                <textarea name="deskripsi" id="" cols="30" rows="10" ><?= $value['deskripsi'] ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div class="fg-line">
                                                ...
                                                <br>
                                                <img src="../joimg/client/<?php echo $value['image'];?>" alt="<?php echo $value['image'];?>" width="100px">
                                                <br><br>
                                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                                    <span class="btn btn-success btn-file m-r-10">
                                                        <span class="fileinput-new">Select file</span>
