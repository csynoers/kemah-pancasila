...
<?php
    $aksi="modul/mod_gallery/gallery_c.php?module=gallery&id_kategori=$_GET[id_kategori]";
    if (!isset($_GET['act'])) {
        $_GET['act'] = '';
    }
    switch($_GET['act']){
...
?>
                ...
                <div class="card">
                    <div class="card-body card-padding">
                        <?php 
                            $kat = $database->select($fields="judul", $table="gallery_kategori", $where_clause="WHERE id_kategori='$_GET[id_kategori]'");
                         ?>
                        <p class="c-black f-500 m-b-20"><a href="?module=gallery_kategori">Gallery Category</a> - <?php echo $kat['judul']; ?> - Gallery
                            <a href="?module=gallery&id_kategori=<?php echo $_GET['id_kategori'] ?>&act=add" class="btn bgm-deeppurple btn-sm m-t-10 waves-effect pull-right"><i class="zmdi zmdi-plus zmdi-hc-fw"></i> Add New</a>
                        </p>
                        ...
                        <div class="table-responsive">
                            <table class='display' id='datatables'>
                                ...
                                <?php
                                    $no=1;
                                    $posts = $database->select($fields="*", $table="gallery", $where_clause="WHERE id_kategori = '$_GET[id_kategori]'ORDER BY id_gallery DESC", $fetch="all");
                                ...
                                ?>
                                    ...
                                    <tr>
                                        <th><?php echo $no; ?></th>
                                        <td><img src="../joimg/gallery/<?php echo $value['image'];?>" alt="" width="50px"></td>
                                        ...
                                        <td>
                                            <a href="?module=gallery&id_kategori=<?php echo $_GET['id_kategori'] ?>&act=edit&id=<?php echo $value['id_gallery'];?>" class="btn bgm-teal waves-effect"><i class="zmdi zmdi-edit zmdi-hc-fw"></i> Edit</a>
                                            <a href="<?php echo "$aksi&act=delete&id=$value[id_gallery]";?>" class="btn bgm-pink waves-effect" onclick="return confirm('Apakah anda yakin menghapus data ini?');"><i class="zmdi zmdi-delete zmdi-hc-fw"></i> Delete</a>
                                        </td>
                                    </tr>
...
?>
                   <div class="card">
                        ...
                        <?php 
                            $kat = $database->select($fields="judul", $table="gallery_kategori", $where_clause="WHERE id_kategori='$_GET[id_kategori]'");
                         ?>
                        <p class="c-black f-500 m-b-20"><a href="?module=gallery_kategori">Gallery Category</a> - <?php echo $kat['judul']; ?> - Gallery / Add New</p>
                            <hr class="line">
                                                    ...
                                                    <div class="fg-line">
                                                        ...
                                                        <div class="select">
                                                            <select class="form-control" name="kategori" id="d_kategori" required="require">
                                                                ...
                                                                <?php
                                                                    $kat = $database -> select($fields='*', $table='gallery_kategori', $where_clause='ORDER BY id_kategori DESC', $fetch='all'); 
                                                                    foreach ($kat as $key => $k) {
                                                                    if ($k['id_kategori']==$_GET['id_kategori']) {
                                                                            echo '<option value="'.$k['id_kategori'].'" selected>'.$k['judul'].'</option>';
                                                                        } else {
                                                                            echo '
...
?>
                   ...
                   <div class="card">
                        ...
                        <?php 
                            $kat = $database->select($fields="judul", $table="gallery_kategori", $where_clause="WHERE id_kategori='$_GET[id_kategori]'");
                         ?>
                        <p class="c-black f-500 m-b-20"><a href="?module=gallery_kategori">Gallery Category</a> - <?php echo $kat['judul']; ?> - Gallery / Edit</p>
                            <hr class="line">
                                                        ...
                                                        <div class="select">
                                                            <select class="form-control" name="kategori" id="d_kategori" required="require">
                                                                <?php
                                                                    $kat = $database -> select($fields='*', $table='gallery_kategori', $where_clause='ORDER BY id_kategori DESC', $fetch='all'); 
                                                                    foreach ($kat as $key => $k) {
                                                                        if ($k['id_kategori']==$value['id_kategori']) {
                                                                            echo '<option value="'.$k['id_kategori'].'" selected>'.$k['judul'].'</option>';
                                                                        } else {
                                                                            echo '
                                                                                <option value="'.$k['id_kategori'].'">'.$k['judul'].'</option>
