...
<?php
    $aksi="modul/mod_gallery/gallery_c.php?module=gallery";
    if (!isset($_GET['act'])) {
        $_GET['act'] = '';
    }
    switch($_GET['act']){
...
?>
                ...
                <div class="card">
                    <div class="card-body card-padding">
                        ...
                        <p class="c-black f-500 m-b-20">Gallery
                            <a href="?module=gallery&act=add" class="btn bgm-deeppurple btn-sm m-t-10 waves-effect pull-right"><i class="zmdi zmdi-plus zmdi-hc-fw"></i> Add New</a>
                        </p>
                        ...
                        <div class="table-responsive">
                            <table class='display' id='datatables'>
                                ...
                                <?php
                                    $no=1;
                                    $posts = $database->select($fields="*", $table="gallery", $where_clause="ORDER BY id_gallery DESC", $fetch="all");
                                    foreach ($posts as $key => $value) {
                                        $kat = $database->select($fields="judul", $table="gallery_kategori", $where_clause="WHERE id_gallery_kategori='$value[id_gallery_kategori]'");
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="?module=gallery&act=edit&id=<?php echo $value['id_gallery'];?>&kateg=<?php echo $value['id_gallery_kategori'] ?>" class="btn bgm-teal waves-effect"><i class="zmdi zmdi-edit zmdi-hc-fw"></i> Edit</a>
