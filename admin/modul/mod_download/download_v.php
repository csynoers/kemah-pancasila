...
<?php
    $aksi="modul/mod_download/download_c.php?module=download";
    if (!isset($_GET['act'])) {
        $_GET['act'] = '';
    }
    switch($_GET['act']){
...
?>
                ...
                <div class="card">
                    <div class="card-body card-padding">
                        ...
                        <p class="c-black f-500 m-b-20">Download
                            <a href="?module=download&act=add" class="btn bgm-deeppurple btn-sm m-t-10 waves-effect pull-right"><i class="zmdi zmdi-plus zmdi-hc-fw"></i> Add New</a>
                        </p>
                        ...
                        <div class="table-responsive">
                            <table class='display' id='datatables'>
                                ...
                                <?php
                                    $no=1;
                                    $posts = $database->select($fields="*", $table="download", $where_clause="ORDER BY id_download DESC", $fetch="all");
                                ...
                                ?>
                                    ...
                                    <tr>
                                        <th><?php echo $no; ?></th>
                                        <td><a href="../file/download/<?php echo $value['image'];?>" alt="<?php echo $value['image']; ?>" width="50px" target="_blank"><?php echo $value['image']; ?></a></td>
                                        <td><?php echo $value['nama']; ?></td>
                                        <td><?php if($value['status'] == '1'){echo "<span style='color: green'>Publish</span>";}else{echo "<span style='color: red'>Hidden</span>";} ?></td>
                                        <td>
                                            <a href="?module=download&act=edit&id=<?php echo $value['id_download'];?>" class="btn bgm-teal waves-effect"><i class="zmdi zmdi-edit zmdi-hc-fw"></i> Edit</a>
                                            <a href="<?php echo "$aksi&act=delete&id=$value[id_download]";?>" class="btn bgm-pink waves-effect" onclick="return confirm('Apakah anda yakin menghapus data ini?');"><i class="zmdi zmdi-delete zmdi-hc-fw"></i> Delete</a>
                                        </td>
                                    </tr>
...
?>
                   <div class="card">
                        <div class="card-body card-padding">
                            <p class="c-black f-500 m-b-20">Download / Add New</p>
                            <hr class="line">

                            <form id="download-form" method="post" enctype="multipart/form-data" action="<?php echo $aksi;?>&act=insert">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <div class="fg-line">
                                                <label>File <span class="color-red">*</span></label>
                                                <br>
                                ...
                                <br>
                                <div class="alert alert-info" role="alert"><b>Attention!</b> <br><p style="font-size: 13px;"><b>File Type :</b> JPG, PNG, JPEG. <b>Size :</b> 190 x 120 pixels</div>
...
<?php
    ...
    case "edit":
    $id         = $_GET['id'];
    $value      = $database->select($fields="*", $table="download", $where_clause="WHERE id_download = '$id'", $fetch="");
?>

                   <div class="card">

                        <div class="card-body card-padding">
                            <p class="c-black f-500 m-b-20">Download / Edit</p>
                            <hr class="line">

                            <form id="download-form" method="post" enctype="multipart/form-data" action="<?php echo $aksi;?>&act=update">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <div class="fg-line">
                                                <label>File</label>
                                                <br>
                                                <img src="../file/download/<?php echo $value['image'];?>" alt="<?php echo $value['image'];?>" width="300px">
                                                <br><br>
                                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                                    <span class="btn btn-success btn-file m-r-10">
                                                        <span class="fileinput-new">Select file</span>
