...
<?php
    $aksi="modul/mod_program/program_c.php?module=program";
    switch($_GET['act']){
    default:
?>
        ...
        <div class="card">
            <div class="card-body card-padding">
                ...
                <p class="c-black f-500 m-b-20">Program
                    <a href="?module=program&act=add" class="btn bgm-deeppurple btn-sm m-t-10 waves-effect pull-right"><i class="zmdi zmdi-plus zmdi-hc-fw"></i> Add New</a>
                </p>
                ...
                <div class="table-responsive">
                    <table class='display' id='datatables'>
                        ...
                        <?php
                            $no=1;
                            $posts = $database->select($fields="*", $table="program", $where_clause="ORDER BY id_program DESC", $fetch="all");
                            foreach ($posts as $key => $value) {
                            $nk = $database->select($fields="nama", $table="program_kategori", $where_clause="WHERE id_program_kategori = '$value[id_program_kategori]'", $fetch="");
                        ?>
                            ...
                            <tr>
                                ...
                                <td><img src="../joimg/program/thumbnail/<?php echo $value['image'];?>" alt="" width="80px"></td>
                                ...
                                <td>
                                    <a href="?module=program&act=edit&id=<?php echo $value['id_program'];?>" class="btn bgm-teal waves-effect"><i class="zmdi zmdi-edit zmdi-hc-fw"></i> Edit</a>
                                    <a href="<?php echo "$aksi&act=delete&id=$value[id_program]";?>" class="btn bgm-pink waves-effect" onclick="return confirm('Apakah anda yakin menghapus data ini?');"><i class="zmdi zmdi-delete zmdi-hc-fw"></i> Delete</a>
                                </td>
                            </tr>
...
?>
        <div class="card">
            <div class="card-body card-padding">
                <p class="c-black f-500 m-b-20">Program / Add New</p>
                <hr class="line">
                                ...
                                <div class="fg-line">
                                    ...
                                    <div class="select">
                                        <select class="form-control" name="kategori" id="d_kategori" required="require">
                                            ...
                                            <?php
                                                $kat = $database -> select($fields='*', $table='program_kategori', $where_clause='ORDER BY id_program_kategori DESC', $fetch='all'); 
                                                foreach ($kat as $key => $k) {
                                                    echo '
                                                        <option value="'.$k['id_program_kategori'].'">'.$k['nama'].'</option>
                                                    ';
                                                }
                                            ?>
                                        </select>
...
<?php
    ...
    case "edit":
    $id         = $_GET['id'];
    $value      = $database->select($fields="*", $table="program", $where_clause="WHERE id_program = '$id'", $fetch="");
?>

        <div class="card">

            <div class="card-body card-padding">
                <p class="c-black f-500 m-b-20">Program / Edit</p>
                <hr class="line">
                                        ...
                                        <div class="select">
                                            <select class="form-control" name="kategori" id="d_kategori" required="require">
                                                ...
                                                <?php
                                                    $kat = $database -> select($fields='*', $table='program_kategori', $where_clause='ORDER BY id_program_kategori DESC', $fetch='all'); 
                                                    foreach ($kat as $key => $k) {
                                                        if ($k['id_program_kategori']==$value['id_program_kategori']) {
                                                            echo '<option value="'.$k['id_program_kategori'].'" selected>'.$k['nama'].'</option>';
                                                        } else {
                                                            echo '
                                                                <option value="'.$k['id_program_kategori'].'">'.$k['nama'].'</option>
                                                            ';
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="fg-line">
                                    <label>Image</label>
                                    <br>
                                    <img src="../joimg/program/thumbnail/<?php echo $value['image'];?>" alt="<?php echo $value['image'];?>" width="300px">
                                    <br><br>
                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                            <span class="btn btn-success btn-file m-r-10">
                                                <span class="fileinput-new">Select file</span>
