...
<?php
    $aksi="modul/mod_program_kategori/program_kategori_c.php?module=program_kategori";
    switch($_GET['act']){
    default:
?>
                ...
                <div class="card">
                    <div class="card-body card-padding">
                        ...
                        <p class="c-black f-500 m-b-20">Blog Kategori
                            <a href="?module=program_kategori&act=add" class="btn bgm-deeppurple btn-sm m-t-10 waves-effect pull-right"><i class="zmdi zmdi-plus zmdi-hc-fw"></i> Add New</a>
                        </p>
                        ...
                        <div class="table-responsive">
                            <table class='display' id='datatables'>
                                ...
                                <?php
                                    $no=1;
                                    $posts = $database->select($fields="*", $table="program_kategori", $where_clause="ORDER BY id_program_kategori DESC", $fetch="all");
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="?module=program_kategori&act=edit&id=<?php echo $value['id_program_kategori'];?>" class="btn bgm-teal waves-effect"><i class="zmdi zmdi-edit zmdi-hc-fw"></i> Edit</a>
                                            <a href="<?php echo "$aksi&act=delete&id=$value[id_program_kategori]";?>" class="btn bgm-pink waves-effect" onclick="return confirm('Apakah anda yakin menghapus data ini?');"><i class="zmdi zmdi-delete zmdi-hc-fw"></i> Delete</a>
                                        </td>
                                    </tr>
...
?>
                   <div class="card">
                        ...
                        <div class="card-body card-padding">
                            <p class="c-black f-500 m-b-20">Blog Kategori / Add New</p>
                            <hr class="line">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <div class="fg-line">
                                                <label>Judul program Kategori</label>
...
<?php
    ...
    case "edit":
    $id         = $_GET['id'];
    $value      = $database->select($fields="*", $table="program_kategori", $where_clause="WHERE id_program_kategori = '$id'", $fetch="");
?>

                   <div class="card">

                        <div class="card-body card-padding">
                            <p class="c-black f-500 m-b-20">Blog Kategori / Edit</p>
                            <hr class="line">
