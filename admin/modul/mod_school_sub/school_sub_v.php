...
<?php
    $aksi="modul/mod_school_sub/school_sub_c.php?module=school_sub&id_school=$_GET[id_school]";
    switch($_GET['act']){
    default:
?>
        <div class="card">
            <div class="card-body card-padding">
                <?php 
                    $k = $database->select($fields="*", $table="school", $where_clause="WHERE id_school = $_GET[id_school] ORDER BY id_school ASC", $fetch="");
                 ?>
                <p class="c-black f-500 m-b-20"><a href="?module=school">School</a> - <?php echo $k['name'] ?> - Sub
                    <a href="?module=school_sub&id_school=<?php echo $_GET['id_school'];?>&act=add" class="btn bgm-deeppurple btn-sm m-t-10 waves-effect pull-right"><i class="zmdi zmdi-plus zmdi-hc-fw"></i> Add New</a>
                </p>
                ...
                <div class="table-responsive">
                    <table class='display' id='datatables'>
                        ...
                        <?php
                            $no=1;
                            $posts = $database->select($fields="*", $table="school_sub", $where_clause="WHERE id_school = $_GET[id_school] ORDER BY id_school_sub ASC", $fetch="all");
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <!-- <td><img src="../joimg/school_sub/thumbnail/<?php echo $value['image'];?>" alt="" width="80px"></td> -->
                                <!-- <td><?php echo $value['date']; ?></td> -->
                                <td><?php if($value['status'] == 'Y'){echo "<span style='color: green'>Publish</span>";}else{echo "<span style='color: red'>Hidden</span>";} ?></td>
                                <td>
                                    <a href="?module=school_sub&id_school=<?php echo $_GET['id_school']?>&act=edit&id=<?php echo $value['id_school_sub'];?>" class="btn bgm-teal waves-effect"><i class="zmdi zmdi-edit zmdi-hc-fw"></i> Edit</a>
                                    <a href="<?php echo "$aksi&act=delete&id=$value[id_school_sub]";?>" class="btn bgm-pink waves-effect" onclick="return confirm('Apakah anda yakin menghapus data ini?');"><i class="zmdi zmdi-delete zmdi-hc-fw"></i> Delete</a>
                                </td>
                            </tr>
...
?>
        <div class="card">
            <div class="card-body card-padding"><?php 
                    $k = $database->select($fields="*", $table="school", $where_clause="WHERE id_school = $_GET[id_school] ORDER BY id_school ASC", $fetch="");
                 ?>
                <p class="c-black f-500 m-b-20"><a href="?module=school">School</a> - <?php echo $k['name'] ?> / Add New</p>
                <hr class="line">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <div class="fg-line">
                                    ...
                                    <input type="hidden" name="id_school" value="<?php echo $_GET['id_school'] ?>">
...
<?php
    ...
    case "edit":
    $id         = $_GET['id'];
    $value      = $database->select($fields="*", $table="school_sub", $where_clause="WHERE id_school_sub = '$id'", $fetch="");
?>

        <div class="card">

            <div class="card-body card-padding"><?php 
                    $k = $database->select($fields="*", $table="school_sub", $where_clause="WHERE id_school_sub = $_GET[id] ORDER BY id_school_sub ASC", $fetch="");
                 ?>
                <p class="c-black f-500 m-b-20"><a href="?module=school">School</a> - <?php echo $k['name'] ?> / Edit</p>
                <hr class="line">
                        ...
                        <!-- <div class="col-md-4">
                            <div class="form-group">
                                <div class="fg-line">
                                    <label>Image</label>
                                    <br>
                                    <img src="../joimg/school_sub/thumbnail/<?php echo $value['image'];?>" alt="<?php echo $value['image'];?>" width="300px">
                                    <br><br>
                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                            <span class="btn btn-success btn-file m-r-10">
                                                <span class="fileinput-new">Select file</span>
