    ...
    if ($module=='testimonies' AND $act=='insert')
    {
        ...
        if(!empty($lokasi_file))
        {
            ...
            if ($tipe_file != "image/jpeg" AND $tipe_file != "image/pjpeg" AND $tipe_file != "image/png"){
                echo "<script>alert('Data tidak tersimpan! Upload Gagal, Pastikan File yang di Upload bertipe *.JPG, *.PNG.'); window.location = '../../media.php?module=$module&id_school=$_POST[kategori]';</script>";
                die();
            }
        ...
        echo "<script>alert('Sukses! Data Telah Berhasil Disimpan.'); window.location = '../../media.php?module=$module&id_school=$_POST[kategori]';</script>";
    }
    else
    {
        echo "<script>alert('Maaf! Data Gagal Disimpan, Silahkan coba lagi.'); window.location = '../../media.php?module=$module&id_school=$_POST[kategori]';</script>";
    }
}
